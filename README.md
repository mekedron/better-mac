...
- **[ClipSlop](https://mekedron.github.io/ClipSlop/)** [OpenSource] — 🌟 **FEATURED** 🌟 — Free AI writing tool for macOS. Fix grammar, translate, rewrite, or format text with a hotkey. Works with ChatGPT, Anthropic, and Ollama.
- **[PieSwitcher](https://github.com/mekedron/Bringr)** [OpenSource] — 🌟 **FEATURED** 🌟 — Radial pie-menu window switcher for macOS. Summon a wheel with a gesture, hover an app to fan out its windows with live previews, and click to bring one forward; no Cmd-Tab, no Mission Control.
- **[HiddenBarIcons](https://mekedron.github.io/HiddenBarIcons/)** [OpenSource] - 🌟 **FEATURED** 🌟 - Macs with notch has one significant problem - you can't access menu bars icons if you have too many of them. This app fixes this issue.
- **[OpenTranslate](https://github.com/mekedron/OpenTranslate)** - 🌟 **FEATURED** 🌟 - Missing iOS and macOS Safari extension for translating web pages. Default Safari's translation doesn't support manu languages, such as Finnish. With this extension you could easily read any resources on your iPhone!
...
- [MacsyZones](https://github.com/rohanrhu/MacsyZones) [OpenSource] - Free and Open Source analog of FansyZones on Windows, but for macOS! It's a must-have for a wide screen monitor user. Might be useful for ultra-wide screen displays.</s> <s><b>Deprecated:</b> Use BetterTouchTool for snapping windows.</s> - Unfortunately BetterTouchTool didn't work for me because it was making dragging of windows to laggy.
